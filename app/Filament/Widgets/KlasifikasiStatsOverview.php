    ...
    protected function getStats(): array
    {
        ...
        */
        ...
        $pembinaan = (clone $klasifikasiQuery)
            ->where('label_aktual', 'Butuh Perhatian')
            ->count();

        $bermasalah = (clone $klasifikasiQuery)
            ->where('label_aktual', 'Bermasalah')
            ->count();
        ...
        */
        ...
        return [
            ...
            Stat::make(
                ...
                ->description('Distribusi label aktual pada dataset')
